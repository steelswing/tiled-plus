...
//                    jm.getPopupMenu().setInvoker(null);
    ...
    public static Result showErrorDialog(String title, String message) {
        return Result.get(JOptionPane.showConfirmDialog(frame, new TextPanel().setText(message), title, 2, 0, SwingIconManager.TOOL.WARN_32ICON));
    }

    public static String showInputDialog(String title, String message) {
        return (String) JOptionPane.showInputDialog(frame, title, message, 1, SwingIconManager.TOOL.QUEST_32ICON, null, null);
    }
    ...
    public static Result showErrorDialog(String title, Throwable ex) {
        ...
        error = true;
        Result r = Result.get(JOptionPane.showConfirmDialog(frame, new TextPanel().setText(builder.toString()), title, 2, 0, SwingIconManager.TOOL.WARN_32ICON));
        error = false;
        return r;
    }
